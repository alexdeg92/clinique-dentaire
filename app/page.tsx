...
function Hero() {
  return (
    <section className="relative min-h-screen flex items-center pt-20 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-6 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <p className="text-lg sm:text-xl text-gray-600 mb-8 max-w-lg leading-relaxed break-words">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <a href="#rendez-vous" className="w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-gradient-to-r from-cyan-600 to-teal-600 text-white px-8 py-4 rounded-full text-lg font-semibold shadow-xl shadow-cyan-500/25 hover:shadow-cyan-500/40 transition-all hover:-translate-y-0.5">
          ...
          <div className="mt-12 flex flex-wrap justify-center sm:justify-start items-center gap-6 sm:gap-8">
            ...
            <div className="text-center">
              ...
              <div className="text-xs sm:text-sm text-gray-500">Patients satisfaits</div>
            </div>
            <div className="hidden sm:block w-px h-12 bg-gray-200" />
            <div className="text-center">
